...
/// User Reviews Screen - Display all reviews submitted by the user
...
class _UserReviewsScreenState extends State<UserReviewsScreen> {
  ...
  Future<void> _loadReviews() async {
    ...
    if (user == null) {
      debugPrint('⚠️ Cannot load reviews: User is null');
      return;
    }
    ...
    try {
      await reviewProvider.loadUserReviews(userId);
      debugPrint('📊 Loaded ${reviewProvider.userReviews.length} user reviews');
      ...
      if (reviewProvider.userReviews.isEmpty) {
        ...
        for (var review in reviewProvider.userReviews) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                debugPrint(
                  '📝 Rendering review ${index + 1}/${reviewProvider.userReviews.length}',
                );
                debugPrint('   - Review ID: ${review.id}');
                debugPrint('   - Chef ID: ${review.chefId}');
                debugPrint('   - User: ${review.userName}');
